...
@Test public void attackTest(){
    ...
    player.get(1).addTerritory(new Territory("aaaa","a",2,4));

    System.out.println();
    System.out.println("\n\n\n");
    assertTrue(" attackTest ",!(ge.attack(player.get(0).getTerritoryThatCanAttack(0), player.get(1).getTerritoryThatCanAttack(0), 1).equals(null)));
}
}