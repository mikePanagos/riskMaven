...
public class SetupTest {
    ...
    // (playerList.get(0).getId()==1));
    // assertTrue("someLibraryMethod should return 'true'",
    // (playerList.get(1).getId()==2));
    // assertTrue("someLibraryMethod should return 'true'",
    // (playerList.get(2).getId()==3));
    // }
    // /**
    // * test player id
    // */
    ...
    // assertTrue("someLibraryMethod should return 'true'",
    // (playerList.get(1).getArmiesCount()==40));
    // }
    // /**
    ...
    // assertTrue("someLibraryMethod should return 'true'",
    // (playerList.get(1).getArmiesCount()==35));
    // }
    // /**
    ...
    // assertTrue("someLibraryMethod should return 'true'",
    // (playerList.get(1).getArmiesCount()==30));
    // }
    // /**
    ...
    // assertTrue("someLibraryMethod should return 'true'",
    // (playerList.get(1).getArmiesCount()==25));
    // }
    // /**
    ...
    // assertTrue("someLibraryMethod should return 'true'",
    // (playerList.get(1).getArmiesCount()==20));
    // }

    // /**
    // * test that the territories are created and shows that there is at least in
    ...
    // assertTrue("someLibraryMethod should return 'true'",
    // (ter.get(4).getName().equals("Greenland")));
    // }
    // /**
    ...
    // // assertTrue("someLibraryMethod should return 'true'",
    // (ter.get(4).getNeighboringTerritories().get(0).getName().equals("Iceland")));
    // // assertTrue("someLibraryMethod should return 'true'",
    // (ter.get(4).getNeighboringTerritories().get(1).getName().equals("Northwest")));
    // // assertTrue("someLibraryMethod should return 'true'",
    // (ter.get(4).getNeighboringTerritories().get(2).getName().equals("Ontario")));
    // // assertTrue("someLibraryMethod should return 'true'",
    // (ter.get(4).getNeighboringTerritories().get(3).getName().equals("Quebec")));
